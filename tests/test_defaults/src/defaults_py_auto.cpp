...
void register_defaults_py_auto(py::module &_core, Registry &registry) {
    py::enum_<DefaultsEnum>(_core, "DefaultsEnum", py::arithmetic())
        ...
        .export_values()
    ;
    py::enum_<DefaultsEnumClass>(_core, "DefaultsEnumClass", py::arithmetic())
        ...
        .export_values()
    ;
    py::class_<Defaults> Defaults(_core, "Defaults");
    registry.on(_core, "Defaults", Defaults);
        py::enum_<Defaults::InnerEnum>(Defaults, "InnerEnum", py::arithmetic())
