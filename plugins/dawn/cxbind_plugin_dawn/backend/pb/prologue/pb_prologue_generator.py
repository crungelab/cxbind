...
from .pb_prologue_render_context import PbPrologueRenderContext

SpecialStructures = ["string view", "nullable string view"]

class PbPrologueGenerator(Generator):
    def __init__(self, backend: "Backend") -> None:
        context = PbPrologueRenderContext(backend.program.unit, backend.program.root, backend.jinja_env)
